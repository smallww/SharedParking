...
import com.cat.R;
import com.cat.SegmentedGroup;
import com.cat.adapter.SearchResultAdapter;
...
//        requestWindowFeature(Window.FEATURE_NO_TITLE);
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(HomeActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    InputtipsQuery inputquery = new InputtipsQuery(newText, "桂林");
                    Inputtips inputTips = new Inputtips(HomeActivity.this, inputquery);
    ...
    private void setUpMap() {
        ...
        myLocationStyle.strokeColor(Color.TRANSPARENT);// 设置边框的颜色
        myLocationStyle.radiusFillColor(Color.TRANSPARENT);// 设置边框的填充色
        ...
        aMap.getUiSettings().setZoomControlsEnabled(false);
        //aMap.moveCamera(CameraUpdateFactory.zoomTo(16));//缩放地图级别
    }
...
//        Log.i("MY", "geoAddress"+ searchLatlonPoint.toString());
        ...
        if (searchLatlonPoint != null){
            RegeocodeQuery query = new RegeocodeQuery(searchLatlonPoint, 400, GeocodeSearch.AMAP);// 第一个参数表示一个Latlng，第二参数表示范围多少米，第三个参数表示是火系坐标系还是GPS原生坐标系
...
//        Log.i("MY", "doSearchQuery");
        currentPage = 0;
        //商业住宅
        String searchType="120000|120100|120200|120201|120202|120203|120300|120300|120301|120302|120303|120304";
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(HomeActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(HomeActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
...
//        firstItem.setAdName("");
    ...
    public static  HomeActivity getInstance(){
        return HomeActivityHolder.INSTANCE;
    }
